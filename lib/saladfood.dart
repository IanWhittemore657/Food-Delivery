...
class saladFood extends StatelessWidget {
          ...
          child: Container(
            child: ListView(
              children: <Widget>[
                FirstHalf(),
                SizedBox(height: 45),
                for (var saladItem in saladitemslist.saladItems)
                  Builder(
                    builder: (context) {
                      return ItemContainer(saladItem: saladItem);
                    },
                  )
              ],
            ),
...
//        addToCart(saladItem);
        final snackBar = SnackBar(
          content: Text('${saladItem.title} added to Cart'),
      ...
      child: Items(
          desc: saladItem.desc,
          itemName: saladItem.title,
          itemPrice: saladItem.price,
          imgUrl: saladItem.imgUrl,
