    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          //can simply add the other items to this so that it workout everything
...
//          ),
  ...
  String returnTotalAmount(List<FoodItem> foodItems) {
    ...
    for (int i = 0; i < foodItems.length; i++) {
      //todo add all items
      //add the total of all items in this function
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          Expanded(
            flex: 1,
            //todo add multiple children with different foods
