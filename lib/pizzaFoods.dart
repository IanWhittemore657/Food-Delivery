          ...
          child: Container(
            child: ListView(
              children: <Widget>[
                FirstHalf(),
                SizedBox(height: 45),
                for (var pizzaItem in pizzaitemlist.pizzaItems)
                  Builder(
                    builder: (context) {
                      return ItemContainer(pizzaItem: pizzaItem);
                    },
                  )
              ],
            ),
...
//        addToCart(saladItem);
        final snackBar = SnackBar(
          content: Text('${pizzaItem.title} added to Cart'),
      ...
      child: Items(
          desc: pizzaItem.desc,
          itemName: pizzaItem.title,
          itemPrice: pizzaItem.price,
