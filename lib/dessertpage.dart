...
import 'package:fooddelivery/fishfoods.dart';
import 'package:fooddelivery/main.dart';
import 'package:fooddelivery/model/desserts.dart';
import 'package:fooddelivery/model/fishitems.dart';
import 'package:fooddelivery/model/fooditem.dart';
import 'package:fooddelivery/model/pizzaItems.dart';
...
class DessertFood extends StatelessWidget {
          ...
          child: Container(
            child: ListView(
              children: <Widget>[
                FirstHalf(),
                SizedBox(height: 45),
                for (var dessertItem in dessertitemslist.dessertItems)
                  Builder(
                    builder: (context) {
                      return ItemContainer(dessertItem: dessertItem);
                    },
                  )
              ],
            ),
...
//        addToCart(saladItem);
        final snackBar = SnackBar(
          content: Text('${dessertItem.title} added to Cart'),
      ...
      child: Items(
          desc: dessertItem.desc,
          itemName: dessertItem.title,
          itemPrice: dessertItem.price,
          imgUrl: dessertItem.imgUrl,
